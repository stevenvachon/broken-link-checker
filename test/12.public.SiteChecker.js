...
describe("PUBLIC -- SiteChecker", () =>
{
	...
	describe("events", () =>
	{
		it(HTML_EVENT, done =>
		{
			...
			.enqueue("http://blc1/simple/index.html", 123);
		});
		...
		it(END_EVENT, done =>
		{
			...
			.enqueue("http://blc1/simple/index.html");
		});
	...
	describe("clearCache()", () =>
	{
		it("works", done =>
		{
			...
			.on(END_EVENT, () =>
			{
				...
				{
					instance.enqueue("http://blc1/simple/index.html");
	...
	describe("dequeue() / numSites / numPages / numQueuedLinks", () =>
	{
		it("accepts a valid id", done =>
		{
			...
			const url = "http://blc1/simple/index.html";
	...
	describe("edge cases", () =>
	{
		it("supports custom data", done =>
		{
			...
			.enqueue("http://blc1/simple/index.html", {test:"value"});
		});
		...
		it("supports html with no links", done =>
		{
			...
			.enqueue("http://blc1/simple/no-links.html");
		});
		...
		it("supports pages after html with no links", done =>
		{
			...
			instance.enqueue("http://blc1/simple/no-links.html");
			instance.enqueue("http://blc1/simple/index.html");
		});
		...
		it("reports a page+site error when first page's html cannot be retrieved", done =>
		{
			...
			.enqueue("http://blc1/simple/404.html");
		});
		...
		it("does not report site error when non-first page's html cannot be retrieved", done =>
		{
			...
			.enqueue("http://blc1/simple/with-links.html");
		});
		...
		it("supports sites after first page's html could not be retrieved", done =>
		{
			...
			instance.enqueue("http://blc1/simple/404.html");
			instance.enqueue("http://blc1/simple/no-links.html");
		});
		...
		// @todo does not check a non-first page that redirects to another site when options.excludeLocalLinks=true
	});
