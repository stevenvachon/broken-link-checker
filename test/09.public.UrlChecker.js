...
describe("PUBLIC -- UrlChecker", () =>
{
	...
	describe("numActiveLinks", () =>
	{
		it("works", done =>
		{
			...
			instance.enqueue("http://blc/simple/no-links.html");
	...
	describe("caching", () =>
	{
		it("requests a unique url only once", done =>
		{
			...
			instance.enqueue("http://blc/simple/index.html",    {index:0});
			instance.enqueue("http://blc/simple/index.html",    {index:1});
			instance.enqueue("http://blc/simple/no-links.html", {index:2});
		});
		...
		it("re-requests a non-unique url after clearing cache", done =>
		{
			...
			const url1 = "http://blc/simple/index.html";
			const url2 = "http://blc/simple/no-links.html";
		...
		it("re-requests a non-unique url after expiring in cache", done =>
		{
			...
			const url = "http://blc/simple/no-links.html";
	...
	describe("edge cases", () =>
	{
		...
		it("supports multiple queue items", done =>
		{
			...
			const url1 = "http://blc/simple/index.html";
			const url2 = "http://blc/simple/no-links.html";
			const url3 = "http://blc/simple/404.html";
