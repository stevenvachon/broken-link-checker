...
describe("API", () =>
{
	it("has necessary exports", () =>
	{
		...
		modules.forEach(module =>
		{
			...
			classes.forEach(key => expect(module[key]).to.be.a("function"));
			objects.forEach(key => expect(module[key]).to.be.an("object"));
			strings.forEach(key => expect(module[key]).to.be.a("string"));
		});
	});
});
