...
import {ExpectedHTMLMediaTypeError, HTMLRetrievalError} from "../lib/internal/errors";
...
describe("INTERNAL -- streamHTML", () =>
{
	...
	[
		{
			message: new ExpectedHTMLMediaTypeError("image/gif").message,
			title: "rejects a non-html url (gif)",
			url: new URL("http://blc/non-html/image.gif")
		},
		{
			message: new ExpectedHTMLMediaTypeError().message,
