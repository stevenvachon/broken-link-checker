...
const baseURL = "http://blc1/simple/index.html";
...
describe("PUBLIC -- HtmlChecker", () =>
{
	...
	describe("options", () =>
	{
		...
		it("excludeLocalLinks = false", done =>
		{
			let htmlString = `<a href="http://blc1/">link1</a>`;
			htmlString += `<a href="/">link2</a>`;
		...
		it("excludeLocalLinks = true", done =>
		{
			let htmlString = `<a href="http://blc1/">link1</a>`;
			htmlString += `<a href="/">link2</a>`;
			htmlString += `<a href="#hash">link3</a>`;

			const options = rawOptions({ excludeLocalLinks:true });
			const junkResults = [];
		...
		it("excludeRemoteLinks = false", done =>
		{
			let htmlString = `<a href="http://blc1/">link1</a>`;
			htmlString += `<a href="http://blc2/">link2</a>`;
		...
		it("excludeRemoteLinks = true", done =>
		{
			let htmlString = `<a href="http://blc1/">link1</a>`;
			htmlString += `<a href="http://blc2/">link2</a>`;

			const junkResults = [];
			const options = rawOptions({ excludeRemoteLinks:true });
			const results = [];
