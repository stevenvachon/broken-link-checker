...
const generateData = () => Object.entries(htmls).reduce((result, [key, value]) =>
{
	...
	result[key] =
	{
		...
		link:
		{
			...
			originalURL: "",
			resolvedURL: { href:"http://domain.com/" },
			rebasedURL:  { href:"http://domain.com/" },
			redirectedURL: null,
			resolvedBaseURL: { href:"http://domain.com/" },
			rebasedBaseURL:  { href:"http://domain.com/" },
			htmlSelector: "",
			htmlTagName: "",
			htmlAttrName: "",
			htmlTag: "",
