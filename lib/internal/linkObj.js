...
linkObj.resolve = function(link, base, options)
{
	...
	// TODO :: what about "0" urls?
	var base_parsed     = urlobj.normalize( urlobj.parse(base || "", parseOptions) );
	var htmlBase_parsed = urlobj.normalize( urlobj.parse(link.html.base || "", parseOptions) );
	...
	var linkOrg_parsed = urlobj.parse(link.url.original || "", parseOptions);
