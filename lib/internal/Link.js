...
export const IS_LOCAL = "isLocal";          // If the link is to the same host as its base/document
...
export default class Link extends Map
{
	...
	#relateWithBase()
	{
		...
		else
		{
			...
			super.set(IS_LOCAL,     relation.upTo(URLRelation.HOST));
