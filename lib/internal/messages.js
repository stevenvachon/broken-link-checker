...
Object.keys(errno).forEach(code => reasons[`ERRNO_${code}`] = `${errno[code].description} (${code})`);

Object.keys(statusCodes).forEach(code => reasons[`HTTP_${code}`] = `${statusCodes[code]} (${code})`);



module.exports = { errors, reasons };
