...
const argsToOptions = args =>
{
	const renames =
	{
		...
		excludeLocal: "excludeLocalLinks",
		excludeRemote: "excludeRemoteLinks",
...
export default (args=process.argv) =>
{
	...
	const optionator = require("optionator")(
	{
		...
		[
			...
			{ option:"exclude-local",    alias:"l", type:"Boolean",  description:"Skip checking of local links",                                      default:"false" },
			{ option:"exclude-remote",   alias:"R", type:"Boolean",  description:"Skip checking of remote links",                                     default:"false" },
