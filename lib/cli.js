...
function cli()
{
	...
	this.nopter.config(
	{
		...
		options:
		{
			...
			"follow":
			{
				rename: "followDisallowed",
				short: "f",
				info: "Follow disallowed paths and nofollow links.",
				type: Boolean
			},
			"get":
			{
...
cli.prototype.input = function(args, showArgs)
{
	...
	else if (args.input != null)
	{
		...
		run(args.input,
		{
			...
			honorDisallowed:        args.followDisallowed!==true,
...
function logMetrics(brokenLinks, excludedLinks, totalLinks, preBreak)
{
...
*/
function logMetrics_delayed(brokenLinks, excludedLinks, totalLinks, preBreak)
{
	setImmediate( function()
	{
		logMetrics(brokenLinks, excludedLinks, totalLinks, preBreak);
	});
}
...
function run(url, checkerOptions, logOptions)
{
	...
	handlers =  
	{
		...
		end: function()
		{
			...
			{
				logMetrics_delayed(data.total.brokenLinks, data.total.excludedLinks, data.total.links, true);
			}
		}
	};
