...
function argsToOptions(args)
{
	...
	return Object.keys(args).reduce((opts, arg) =>
	{
      ...
      if (typeof args[arg] == 'object') {
        opts[arg] = Object.assign({}, defaultOptions[arg], args[arg]);
      } else {
        opts[arg] = args[arg]
      }
		}
...
function cli(args=process.argv)
{
	...
	const optionator = require("optionator")(
	{
      ...
      { option:"httpHeaders",      alias:"H", type:"Object",   description:"Pass custom header LINE to http client", mergeRepeatedObjects: true },
