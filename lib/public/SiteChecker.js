...
const enqueuePage = (instance, url, customData, auth) =>
{
...
const maybeCheckLink = (instance, link) =>
{
...
const maybeEnqueuePage = (instance, link, customData, auth) =>
{
...
const overrideOptions = (instance, options) =>
{
	const customFilter = options.customFilter;

	options.customFilter = result =>
	{
